...
const Services = () => {
  ...
  //   setServices([...services, newUser]); // Add the new user to the services state
  // };
  ...
  return (
    <div>
      ...
      {/* Pass addUser function to AddUser component */}
    </div>
  );
};

// export { Services, addUser };
...
//  );
// const sortedUsers = filteredData?.sort((item1, item2) => {
//   console.log("ggwp",item1,'hahaha',item2)
//     let value1 = "";
//     let value2 = "";
